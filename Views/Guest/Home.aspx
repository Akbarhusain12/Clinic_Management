                       ...
                       <%-- <div class="DetailsInnerWrapper">--%>
                            <div class="customContent">
                               <h5> <p style="line-height:35px">
                                    ...
                                    from, HeathHub Hospital was established in 1994 by Dr. Vikram Shah, world-renowned
                                ...
                                <p style="line-height:35px">
                                    Known as the leading orthopaedic center of the world, HeathHub Hospital gradually
                                    expanded its horizons across the length and breadth of India. From just one hospital,
                                    today, HeathHub is the largest chain of Hospital in Western and Central India. With
                                    ...
                                    HeathHub has become the centre of excellence for all healthcare needs. HeathHub got
                                    listed on BSE/NSE on December, 2017.
                                </p></h5><br /><br />
                               
                                   <h3> <strong>HeathHub Limited Group of Companies and Business Verticals </strong></h3><br />
                              
                                <h4>Hospital</h4>
                                
                                   <h6>SOCE – HeathHub Orthopaedic Centres of Excellence</h6>
                                    <h6>Multispecialty</h6>
                                    <h6>HeathHub Homecare</h6>
                                   <h6>HeathHub Academy</h6>
                                ...
                                <p>
                                    ...
                                    <li>SAT – HeathHub Advanced Technologies Inc., USA</li>
                                    <li>SGT – HeathHub Global Technologies PTE Ltd, Singapore</li>
...
<%--                    <div class="hospitaldetailsRight col-lg-6 col-md-6 col-sm-12">
                        ...
                        <img class="hospitaldetailsPlay" data-toggle="modal" data-target="#videoModal" src="https://www.HeathHub.org/wp-content/themes/HeathHub/images/playYoutube.png">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="iframe-cotainer">
                                            <iframe width="100%" height="350" src="https://www.youtube.com/embed/o1NhX6dtrHQ?autoplay=0&amp;enablejsapi=1"
                                                ...
                                                title="HeathHub Hospital | Best Super Multi-Specialty Hospital in India"></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
